...
public final /* synthetic */ class ae1 implements xd4 {
    ...
    static {
        ae1 ae1Var = new ae1();
        a = ae1Var;
        hx7 hx7Var = new hx7("com.reader.data.reader.text.core.config.impl.model.ColorThemeDto", ae1Var, 4);
        hx7Var.k("id", true);
        hx7Var.k("color", true);
        hx7Var.k("background", true);
        hx7Var.k("background_path", true);
        descriptor = hx7Var;
    }
    ...
    public final void b(md2 md2Var, Object obj) {
        ...
        ce1Var.getClass();
        String str = ce1Var.d;
        String str2 = ce1Var.c;
        String str3 = ce1Var.b;
        String str4 = ce1Var.a;
    ...
    public final Object c(yd2 yd2Var) {
        ...
        am1VarT.n(m39Var);
        return new ce1(strK, strK2, strK3, strK4, i);
    }
