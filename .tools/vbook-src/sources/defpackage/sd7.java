...
public final /* synthetic */ class sd7 implements xd4 {
    ...
    static {
        sd7 sd7Var = new sd7();
        a = sd7Var;
        hx7 hx7Var = new hx7("com.reader.data.sync.impl.model.OldSyncName", sd7Var, 3);
        hx7Var.k("name", true);
        hx7Var.k("replace", true);
        hx7Var.k("ignore_case", true);
        descriptor = hx7Var;
    }
    ...
    public final Object c(yd2 yd2Var) {
        ...
        am1VarT.n(m39Var);
        return new ud7(i, strK, strK2, z2);
    }
