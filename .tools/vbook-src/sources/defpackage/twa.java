...
public final /* synthetic */ class twa implements xd4 {
    public static final twa a;
    private static final m39 descriptor;

    static {
        twa twaVar = new twa();
        a = twaVar;
        hx7 hx7Var = new hx7("com.reader.data.community.api.dto.TokenDto", twaVar, 1);
        hx7Var.k("token", true);
        descriptor = hx7Var;
    }
