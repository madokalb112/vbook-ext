...
public final class zzaen {
    ...
    */
    public static defpackage.vy3 zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 550
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):vy3");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof ny3) {
            return ((ny3) exc).a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof ny3) {
            return ((ny3) exc).a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof ny3) {
            return ((ny3) exc).a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }

    public static vy3 zza(Status status, x20 x20Var, String str, String str2) {
        int i = status.a;
        if (i != 17012 && i != 17007 && i != 17025) {
            return zza(status);
        }
        return new qy3(zza(i), zza(zzb(i), status));
    }

    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.b) ? str : String.format(tw2.n(str, " [ %s ]"), status.b);
    }

    public static py3 zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, rz3 rz3Var) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<cx6> listZzc = zzaasVar.zzc();
        ArrayList arrayList = new ArrayList();
        Iterator<cx6> it = listZzc.iterator();
        while (it.hasNext()) {
            js7 js7Var = (cx6) it.next();
            if (js7Var instanceof js7) {
                arrayList.add(js7Var);
            }
        }
        List<cx6> listZzc2 = zzaasVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        Iterator<cx6> it2 = listZzc2.iterator();
        while (it2.hasNext()) {
            h1b h1bVar = (cx6) it2.next();
            if (h1bVar instanceof h1b) {
                arrayList2.add(h1bVar);
            }
        }
        List<cx6> listZzc3 = zzaasVar.zzc();
        String strZzb = zzaasVar.zzb();
        ex1.C(listZzc3);
        ex1.z(strZzb);
        ArrayList arrayList3 = new ArrayList();
        ArrayList arrayList4 = new ArrayList();
        Iterator<cx6> it3 = listZzc3.iterator();
        while (it3.hasNext()) {
            h1b h1bVar2 = (cx6) it3.next();
            if (h1bVar2 instanceof js7) {
                arrayList3.add((js7) h1bVar2);
            } else if (h1bVar2 instanceof h1b) {
                arrayList4.add(h1bVar2);
            } else {
                gp.l("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(h1bVar2.b()));
                return null;
            }
        }
        gy3 gy3Var = firebaseAuth.a;
        gy3Var.a();
        String str3 = gy3Var.b;
        zzaasVar.zza();
        ex1.z(str3);
        return new py3(str, str2);
    }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof ny3) {
            return ((ny3) exc).a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
