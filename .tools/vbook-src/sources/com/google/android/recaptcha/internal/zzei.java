...
public final class zzei extends SQLiteOpenHelper {
    ...
    public /* synthetic */ zzei(Context context, zf2 zf2Var) {
    ...
    public final int zza(List list) {
        ...
        return getWritableDatabase().delete("ce", "id IN ".concat(fc1.D0(list, ", ", "(", ")", zzeh.zza, 24)), null);
    }
