...
final class zzlg extends zzli {
    ...
    private final void zzL(int i) throws zznn {
        ...
        if (i > (Integer.MAX_VALUE - this.zzk) - this.zzi) {
            ifc.h("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
        } else {
            ifc.h("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
        }
    }
    ...
    private final boolean zzM(int i) throws IOException {
        ...
        int i4 = this.zzg;
        if (i3 <= i4) {
            gp.j(xv5.k(i, "refillBuffer() called when ", " bytes were already available in buffer"));
            return false;
        }
        int i5 = this.zzk;
    ...
    public final boolean zzE(int i) throws zznn {
        ...
        if (i2 == 0) {
            if (this.zzg - this.zzi < 10) {
                ...
                ifc.h("CodedInputStream encountered a malformed varint.");
                return false;
            }
            while (i3 < 10) {
                byte[] bArr = this.zzf;
