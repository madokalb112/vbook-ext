...
public class NativeJavaPackage extends ScriptableObject {
    ...
    public NativeJavaPackage forcePackage(String str, Scriptable scriptable) {
        ...
        NativeJavaPackage nativeJavaPackage = new NativeJavaPackage(true, this.packageName.length() == 0 ? str : dx1.h(this.packageName, ".", str), this.classLoader);
    ...
    public String toString() {
        return xv5.p("[JavaPackage ", this.packageName, "]");
    }
