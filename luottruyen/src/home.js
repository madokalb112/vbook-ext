...
function execute() {
    return Response.success([
        ...
        {title: "Số chapter", input: BASE_URL + "/tim-truyen?status=-1&sort=30", script: "gen.js"},
        {title: "Hoàn thành", input: BASE_URL + "/tim-truyen?status=2&sort=0", script: "gen.js"},
        {title: "Đang tiến hành", input: BASE_URL + "/tim-truyen?status=1&sort=0", script: "gen.js"}
    ]);
}
