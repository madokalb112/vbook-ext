...
function execute() {
    return Response.success([
        {title: "Webtoon", input: BASE_URL + "/ing", script: "gen.js"},
        {title: "Completed Webtoon", input: BASE_URL + "/end", script: "gen.js"},
        {title: "Manhwa", input: BASE_URL + "/manhwa", script: "gen.js"},
        {title: "Novel", input: BASE_URL + "/novel", script: "gen.js"},
        {title: "Ranking", input: BASE_URL + "/rank", script: "gen.js"},
        {title: "Recent", input: BASE_URL + "/recent", script: "gen.js"}
    ]);
}
